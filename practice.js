...
//Code here
let sayHi = (name) => { return "Hello, " + name}
...
//Code Here
let newGreeting = (name) => { return "Hello, " + name}
...
const nameCheck = (name) => {
  return (name == "Steven") ? 'What is up Steven?' : (name == "Byran") ? 'Hey Bryan!' : `Cool name, ${name}`
}
